...
- [x] Implement `src/install.sh` for build tool dependencies 2026-05-15
- [x] Implement `test/install.sh` for testing tool dependencies 2026-05-15
- [x] Configure GitHub Actions workflow for CI/CD 2026-05-15
- [x] Setup initial `pytest` configuration 2026-05-15
