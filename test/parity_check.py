...
def test_help():
    ...
    keywords = ["csv-path", "id-query", "output-dir", "dsn", "user", "password", "table", "id-column", "clob-column"]
    for kw in keywords:
        if kw.lower() not in p_out.lower():
    ...
    keywords = ["csv-path", "id-query", "input-dir", "dsn", "user", "password", "table", "id-column", "clob-column", "id-as-regex"]
    for kw in keywords:
        if kw.lower() not in p_out.lower():
